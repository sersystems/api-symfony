 ...
 */
final class Version20220116064645 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE docente (id INT AUTO_INCREMENT NOT NULL, institucion_id INT NOT NULL, user_id INT NOT NULL, apellido VARCHAR(25) NOT NULL, nombre VARCHAR(25) NOT NULL, email VARCHAR(180) NOT NULL, activo TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_FD9FCFA4E7927C74 (email), INDEX IDX_FD9FCFA4B239FBC6 (institucion_id), UNIQUE INDEX UNIQ_FD9FCFA4A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pregunta_desarrollo (id INT AUTO_INCREMENT NOT NULL, modulo_id INT NOT NULL, pregunta VARCHAR(255) NOT NULL, imagen VARCHAR(255) DEFAULT NULL, INDEX IDX_4F3BDB2EC07F55F5 (modulo_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pregunta_multiple (id INT AUTO_INCREMENT NOT NULL, modulo_id INT NOT NULL, texto VARCHAR(255) NOT NULL, imagen VARCHAR(255) DEFAULT NULL, INDEX IDX_B62C6541C07F55F5 (modulo_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE respuesta_multiple (id INT AUTO_INCREMENT NOT NULL, pregunta_multiple_id INT NOT NULL, texto VARCHAR(255) NOT NULL, imagen VARCHAR(255) DEFAULT NULL, correcta TINYINT(1) NOT NULL, puntaje NUMERIC(10, 2) NOT NULL, INDEX IDX_4F7AD3D73D4BD170 (pregunta_multiple_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
